...
// IBMPPCCloudConnectionClient
type IBMPPCCloudConnectionClient struct {
	IBMPPCClient
}

// NewIBMPPCCloudConnectionClient
func NewIBMPPCCloudConnectionClient(ctx context.Context, sess *ibmppcsession.IBMPPCSession, cloudInstanceID string) *IBMPPCCloudConnectionClient {
	return &IBMPPCCloudConnectionClient{
		*NewIBMPPCClient(ctx, sess, cloudInstanceID),
	}
}

// Create a Cloud Connection
func (f *IBMPPCCloudConnectionClient) Create(body *models.CloudConnectionCreate) (*models.CloudConnection, *models.CloudConnectionCreateResponse, error) {
...
func (f *IBMPPCCloudConnectionClient) Get(id string) (*models.CloudConnection, error) {
...
func (f *IBMPPCCloudConnectionClient) GetAll() (*models.CloudConnections, error) {
...
func (f *IBMPPCCloudConnectionClient) Update(id string, body *models.CloudConnectionUpdate) (*models.CloudConnection, *models.JobReference, error) {
...
func (f *IBMPPCCloudConnectionClient) Delete(id string) (*models.JobReference, error) {
...
func (f *IBMPPCCloudConnectionClient) AddNetwork(id, networkID string) (models.Object, *models.JobReference, error) {
...
func (f *IBMPPCCloudConnectionClient) DeleteNetwork(id, networkID string) (models.Object, *models.JobReference, error) {
...
func (f *IBMPPCCloudConnectionClient) GetVPC() (*models.CloudConnectionVirtualPrivateClouds, error) {
